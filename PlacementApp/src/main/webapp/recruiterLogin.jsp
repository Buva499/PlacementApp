	...
	<div class="container">
		<nav class="navbar navbar-expand-lg navbar-light bg-light">
			<div class="container-fluid">
				<a class="navbar-brand" href="index.jsp">Recruiter Login</a>
			</div>
		...
		<br> <br>
		<!-- Login Action -->
		<form action="RecruiterLogin" method="post" class="container-fluid">
			<div class="mb-3">
				<div class="row g-3 align-items-center">
					...
					<div class="col-auto">
						<input type="text" id="exampleInputEmail1" class="form-control"
							aria-describedby="passwordHelpInline" name="cname" required>
					</div>
			...
			<div class="row g-3 align-items-center">
				...
				<div class="col-auto">
					<input type="password" id="inputPassword6" class="form-control"
						aria-describedby="passwordHelpInline" name="cpass" required>
				</div>
